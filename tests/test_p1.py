...
class TestContractScope:
    ...
    def test_contract_unchanged(self):
        """src/contract.py has not been modified from its committed hash."""
        h = hashlib.sha256(
            Path("src/contract.py").read_bytes()
        ).hexdigest()
        assert h == "7ec14063dbea13a6aa389471a0829f7d3d44a845d80f39f8765abcfcbe137fe0", \
    ...
    def test_folds_unchanged(self):
        ...
        assert h == "2de96fe3a6e8a926e920938cfd165e2e80289d6239a25cffba123b5a8c8f7810", \
